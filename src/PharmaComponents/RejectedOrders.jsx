...
const RejectedOrders = () => {
  ...
  const getRejectedOrder = async () => {
    const url =
      "https://mr-dinesh-doctor-patient-backend.vercel.app/api/v1/order/getAllvendorRejectOrder";
    try {
                ...
                {searchD?.map((ele, i) => (
                  <>
                    <tr className="divider " style={{ textAlign: "center" }}>
                      ...
                      <td className="w-68">Customer Name</td>
                      <td className="w-68">
                        <ul>
...
export default HOC2(RejectedOrders);

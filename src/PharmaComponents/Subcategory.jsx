...
const Subcategory = () => {
  ...
  const handleDelete = async(id)=>{
    const url = `https://mr-dinesh-doctor-patient-backend.vercel.app/api/v1/pharmacy/Sub/subcategory/${id}`;
    try{
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const handleCreate = async()=>{
      const url = "https://mr-dinesh-doctor-patient-backend.vercel.app/api/v1/pharmacy/Sub/createSubcategory";
      try{
      ...
      >
        ...
        <Modal.Body>
          ...
          <div className="terms2">
            ...
            {
              isUp?
              <button className="bg-[#6e39eb] text-white p-2 rounded-lg text-sm" onClick={handleUpdate}>
              Update Sub-Category
            </button>
              :
              <button className="bg-[#6e39eb] text-white p-2 rounded-lg text-sm" onClick={handleCreate}>
              Add Sub-Category
            </button>}
          </div>
        </Modal.Body>
...
export default HOC2(Subcategory);
